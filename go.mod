...
require (
	...
	github.com/lwmqwer/Edgex-gpio-demo v0.0.0-20220407043051-c8bf391b92ac
	github.com/lwmqwer/SAKS-SDK-GO v0.0.0-20220407042541-8af5db91903c
)
